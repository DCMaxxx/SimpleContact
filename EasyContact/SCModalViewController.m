...
- (void)viewDidLoad {
    ...
    [_typeImageView setImage:[SCKindHandler iconForKind:_kind andWhite:NO]];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SCNumberCell *cell = [tableView dequeueReusableCellWithIdentifier:ReuIdNumberCell forIndexPath:indexPath];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    SCNumberCell * cell = (SCNumberCell *)[tableView cellForRowAtIndexPath:indexPath];
...
- (IBAction)longPressOnNumber:(UILongPressGestureRecognizer *)gestureRecognizer {
    if ([gestureRecognizer state] == UIGestureRecognizerStateBegan) {
        ...
        SCNumberCell * cell = (SCNumberCell *)[[self tableView] cellForRowAtIndexPath:path];
        NSInteger index = [cell tag];
        
        [[SCFavoritesHandler sharedInstance] toogleContact:_contact number:[cell value] atIndex:index ofKind:_kind];
...
- (UIImage *)getImageFromLabel:(NSString *)label {
    ...
    if (![dic objectForKey:label])
        return [SCKindHandler iconForKind:_kind andWhite:NO];
